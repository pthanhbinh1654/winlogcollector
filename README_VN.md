...
[![Tests](https://img.shields.io/badge/Tests-8%2F8%20Passing-brightgreen?logo=powershell)](tests/Unit/)
...
| Unit test | 8/8 test qua (state, admin, channel validation, archive, sidecar, UTC backoff) |
